...
public class UpdateDb {
	private static InnerVersion[] versions = [ // バージョン番号8桁=年月日+連番
		...
		new (26_08_27_03,"Drop table  IF EXISTS Tran02PosSeisan;","名前の変更"),
		...
		new (26_08_30_01,"ALTER TABLE Tran00Uriage ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran01Tenuri ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran05Ido ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran06Nyukin ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran07Shiharai ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran10IdoOut ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran11IdoIn ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran12Jyuchu ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran13Hachu ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran60Tana ADD COLUMN OldSeqNo NUMBER not null default 0;ALTER TABLE Tran61Chosei ADD COLUMN OldSeqNo NUMBER not null default 0;","旧データのSEQ_NOを追加"),
		new (26_09_01_01,"ALTER TABLE MasterSysman ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN TaxCalcUnit NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN TaxPriceType NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN SlipFormType NUMBER not null default 0;ALTER TABLE MasterShiire ADD COLUMN TaxCalcUnit NUMBER not null default 0;ALTER TABLE MasterShiire ADD COLUMN TaxRounding NUMBER not null default 0;","マスター系 税計算単位、消費税端数処理の追加"),
		new (26_09_01_02,"ALTER TABLE Tran00Uriage RENAME COLUMN Tax To Tax1;ALTER TABLE Tran00Uriage ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE Tran00Uriage ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE Tran00Uriage ADD COLUMN TaxCalcUnit NUMBER not null default 0;ALTER TABLE Tran00Uriage ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE Tran01Tenuri RENAME COLUMN Tax To Tax1;ALTER TABLE Tran01Tenuri ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE Tran01Tenuri ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE Tran01Tenuri ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE Tran03Shiire RENAME COLUMN Tax To Tax1;ALTER TABLE Tran03Shiire ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN TaxCalcUnit NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE Tran02Material RENAME COLUMN Tax To Tax1;ALTER TABLE Tran02Material ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN TaxCalcUnit NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE Tran12Jyuchu RENAME COLUMN Tax To Tax1;ALTER TABLE Tran12Jyuchu ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE Tran12Jyuchu ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE Tran12Jyuchu ADD COLUMN TaxRounding NUMBER not null default 0;ALTER TABLE Tran13Hachu RENAME COLUMN Tax To Tax1;ALTER TABLE Tran13Hachu ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE Tran13Hachu ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE Tran13Hachu ADD COLUMN TaxRounding NUMBER not null default 0;","トラン系 税計算単位、消費税端数処理の追加"),
		new (26_09_01_03,"ALTER TABLE SummaryUriKake RENAME COLUMN Tax To Tax1;ALTER TABLE SummaryUriKake ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE SummaryUriKake ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE SummaryUriKake ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE SummaryUriKake ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE SummaryUriKake ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE SummaryUriSei RENAME COLUMN Tax To Tax1;ALTER TABLE SummaryUriSei ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE SummaryUriSei ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE SummaryUriSei ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE SummaryUriSei ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE SummaryUriSei ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE SummaryKaiKake RENAME COLUMN Tax To Tax1;ALTER TABLE SummaryKaiKake ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE SummaryKaiKake ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE SummaryKaiKake ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE SummaryKaiKake ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE SummaryKaiKake ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE SummaryKaiShi RENAME COLUMN Tax To Tax1;ALTER TABLE SummaryKaiShi ADD COLUMN Tax2 NUMBER not null default 0;ALTER TABLE SummaryKaiShi ADD COLUMN Tax3 NUMBER not null default 0;ALTER TABLE SummaryKaiShi ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE SummaryKaiShi ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE SummaryKaiShi ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE Tran00Uriage ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE Tran00Uriage ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE Tran00Uriage ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE Tran01Tenuri ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE Tran01Tenuri ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE Tran01Tenuri ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE Tran02Material ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE Tran12Jyuchu ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE Tran12Jyuchu ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE Tran12Jyuchu ADD COLUMN TaxableAmount3 NUMBER not null default 0;ALTER TABLE Tran13Hachu ADD COLUMN TaxableAmount1 NUMBER not null default 0;ALTER TABLE Tran13Hachu ADD COLUMN TaxableAmount2 NUMBER not null default 0;ALTER TABLE Tran13Hachu ADD COLUMN TaxableAmount3 NUMBER not null default 0;","Summary系の消費税を税区分別Tax1/2/3へ分割し課税対象額TaxableAmount1/2/3を追加 伝票ヘッダにも課税対象額を追加 バージョンアップ後は請求計算・支払計算のやり直しが必要"),
		new (26_09_02_01,"ALTER TABLE SummaryUriKake ADD COLUMN Sonota NUMBER not null default 0;ALTER TABLE SummaryKaiKake ADD COLUMN Sonota NUMBER not null default 0;ALTER TABLE SummaryKaiShi ADD COLUMN Sonota NUMBER not null default 0;","売掛・買掛・支払の各残高へその他売上/その他仕入(区分99)列を追加 請求残(SummaryUriSei)と列構成を揃える 既存データは0で集計のやり直しが必要"),
		new (26_09_02_02,"UPDATE SummaryUriKake SET Balance = TotalSales - TotalIn;UPDATE SummaryUriSei SET Balance = TotalSales - TotalIn;UPDATE SummaryKaiKake SET Balance = TotalShiire - TotalOut;UPDATE SummaryKaiShi SET Balance = TotalShiire - TotalOut;","残高を当期間ネット(正=未回収)へ変更 繰越はテーブルに持たず帳票側で算出する Sonotaの分離には別途全期間の再計算が必要"),
		new (26_09_03_01,"ALTER TABLE SysHistAutoexec ADD COLUMN ElapsedTimeReal double(14,8) not null default 0;UPDATE SysHistAutoexec SET ElapsedTimeReal = ElapsedTime + 0.0;ALTER TABLE SysHistAutoexec DROP COLUMN ElapsedTime;ALTER TABLE SysHistAutoexec RENAME COLUMN ElapsedTimeReal TO ElapsedTime;","ElapsedTimeがint時代のNUMBER列のままだとSQLiteのNUMERIC親和性で整数値がINTEGER格納されNPocoのdoubleキャストに失敗するためREAL型へ変換 既存値は実数として保持する"),
		new (26_09_06_01,"ALTER TABLE MasterSysman ADD COLUMN CostMethod NUMBER not null default 0;ALTER TABLE MasterShohin ADD COLUMN PurchaseType NUMBER not null default 0;ALTER TABLE MasterShohin ADD COLUMN Id_ConsignmentShiire NUMBER not null default 0;ALTER TABLE MasterShohin ADD COLUMN VConsignmentShiire TEXT NOT NULL DEFAULT '{}';ALTER TABLE MasterShohin ADD COLUMN ConsumptionCalcType NUMBER not null default 0;ALTER TABLE MasterShohin ADD COLUMN ConsumptionRateBasisPoints NUMBER not null default 0;ALTER TABLE MasterShohin ADD COLUMN ConsumptionRoundingUnit NUMBER not null default 1;ALTER TABLE MasterShohin ADD COLUMN ConsumptionRounding NUMBER not null default 0;ALTER TABLE Tran03Shiire ADD COLUMN IsStock NUMBER not null default 1;ALTER TABLE Tran03Shiire ADD COLUMN GeneratedKind NUMBER not null default 0;","原価4項目 Step3 原価方式・消化仕入設定・在庫加算フラグの列追加 既存行は現行動作を維持する初期値で補完する"),
		new (26_09_06_02,"ALTER TABLE SysSequence ADD COLUMN SysSeqType NUMBER not null default 0;ALTER TABLE SysSequence ADD COLUMN ExpectedDuration NUMBER not null default 0;ALTER TABLE SysHistAutoexec ADD COLUMN SysHistType NUMBER not null default 0;","マニュアル排他制御 SysSequenceへ連番種別と予想処理時間、SysHistAutoexecへ実行種別を追加 既存行は全て0(テーブル連番/自動実行)で補完する"),
		new (26_09_08_01,"ALTER TABLE MasterTokui ADD COLUMN Id_PriceGroup NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN VPriceGroup TEXT NOT NULL DEFAULT '{}';ALTER TABLE MasterTokui ADD COLUMN Id_PriceArea NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN VPriceArea TEXT NOT NULL DEFAULT '{}';ALTER TABLE MasterTokui ADD COLUMN Id_PriceChannel NUMBER not null default 0;ALTER TABLE MasterTokui ADD COLUMN VPriceChannel TEXT NOT NULL DEFAULT '{}';","上代一括変更 Step1a 得意先へ価格グループ/地域/チャネルの3軸を追加 既存行は全て0(未設定)で全店Scopeのみ適用される"),
		new (26_09_08_02,"INSERT INTO MasterMeisho (Vdc,Vdu,Kubun,KubunName,Code,Name,Ryaku,Kana,Odr) VALUES (strftime('%s','now')*10000000+621355968000000000,strftime('%s','now')*10000000+621355968000000000,'IDX','名称区分','C30','価格グループ','','',30),(strftime('%s','now')*10000000+621355968000000000,strftime('%s','now')*10000000+621355968000000000,'IDX','名称区分','C31','地域','','',31),(strftime('%s','now')*10000000+621355968000000000,strftime('%s','now')*10000000+621355968000000000,'IDX','名称区分','C32','チャネル','','',32);","上代一括変更 Step1a 得意先価格グループ3軸の名称区分(C30価格グループ/C31地域/C32チャネル)をMasterMeishoのIDX行として追加 グループ実体は運用登録のため初期データに含めない"),
	];
