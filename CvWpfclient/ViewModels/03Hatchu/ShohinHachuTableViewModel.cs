...
/// <summary>
/// 商品別発注表。指定期間の発注明細を品番(商品×色×サイズ)別に集計し、
/// 数量・金額・上代金額・伝票数・最終発注日を印字する。色サイズを潰した商品計にも切替できる。
/// </summary>
public partial class ShohinHachuTableViewModel : Helpers.BaseReportViewModel {
	protected override string ReportTitle => "商品別発注表";
	protected override string FormFileName => "ShohinHachuTable.qfm";
