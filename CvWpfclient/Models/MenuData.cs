...
public partial class MenuData : ObservableObject {
	...
	public static ObservableCollection<MenuData> CreateDefault() {
		...
		new("旧DBからの変換処理", typeof(Views._00System.ConcvertDbView), addInfo:"旧OracleDBからのデータ変換 サーバ側にOracle接続定義が必要"),
		new("旧DBからの選択変換処理", typeof(Views._00System.ConcvertSelectedView), addInfo:"旧OracleDBからの選択変換処理 サーバ側にOracle接続定義が必要"),
