...
AI アシスタント向けの作業ルールは [AGENTS.md](AGENTS.md) を参照してください。
...
その後 `CV.net` は、アパレル企業を中心に延べ 200 社へ導入されるまでに成長しました。
...
2025年11月25日に約 30 ファイルの初期リポジトリを登録して以降、既存の `CV.net` 機能の 8 割をカバーできる状態を目指し、2027年1月のリリースに向けて開発を進めています。
