...
/// <remarks>
/// <para>
/// `TranTaxRebuildDb`は対象6伝票（売上/店舗売上/生地・付属仕入/商品仕入/受注/発注）の期首日以降を
/// 全件走査し、取引先マスタの現在値から税計算単位・端数処理を再スナップショットして明細税額・
/// ヘッダ税額を確定する冪等な一括再計算処理である。検証をヘッダTax未設定の状態からの再計算に
/// 絞り込めるよう、そのための**未処理状態の伝票を1件だけ新規投入**する。
/// </para>
/// <para>
