...
public class MasterCascadeDb {
	...
	public static readonly CascadeVRule[] VRules = [
		...
		new (typeof(MasterTokui),        nameof(MasterTokui.Id_PriceGroup),       nameof(MasterTokui.VPriceGroup),       typeof(MasterMeisho)),
		new (typeof(MasterTokui),        nameof(MasterTokui.Id_PriceArea),        nameof(MasterTokui.VPriceArea),        typeof(MasterMeisho)),
		new (typeof(MasterTokui),        nameof(MasterTokui.Id_PriceChannel),     nameof(MasterTokui.VPriceChannel),     typeof(MasterMeisho)),
